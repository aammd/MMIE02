...
```{r}
#| fig-cap: prior predictive simulations of penguin bills
...
```{r}
#| layout-ncol: 2
#| fig-cap: comparisons of priors and posteriors for two parameters, showing how much we've learned from the data.
